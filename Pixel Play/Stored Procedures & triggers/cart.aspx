	...
	<div class="left">
		...
		<table>
			...
			<% 
				...
				string connectionString = "Data source=DESKTOP-UTRLQ39\\SQLEXPRESS02;initial catalog=trying2;integrated Security=true";
...
string query2 = "IF (SELECT PPstuff FROM PP WHERE Name = @name) >= @subtotal " +
                "UPDATE PP SET PPstuff = PPstuff - @subtotal WHERE Name = @name " +
                "ELSE RAISERROR('Insufficient PPstuff', 16, 1)";
