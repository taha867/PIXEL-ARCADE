    ...
    public partial class WebForm6 : System.Web.UI.Page
    {
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				...
				string query = "SELECT ItemID,Itemname,Price,Description,imageurl FROM PCAcc";
		...
		protected void reptProduct_ItemCommand(object source, RepeaterCommandEventArgs e)
		{
			...
			string query = "SELECT ItemID,Itemname,Price,Description,imageurl FROM PCAcc where ItemID=@ItemID";
			SqlCommand command = new SqlCommand(query, connection);
