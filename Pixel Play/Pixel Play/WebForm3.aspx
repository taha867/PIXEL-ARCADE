<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="Pixel_Play.WebForm3" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
        <asp:Label ID="Label1" runat="server" Text="69"></asp:Label>
        <nav class="bilal">
    ...
    <div class="Menubtn">
        ...
        font-size: 16px;
        border: 2px solid rgb(96, 20, 20); 
        border-radius: 0px;" OnClick="BtnPcAcc_Click"/>
    </div>
</nav>
    <br><br/>
    <div class="browse-category">
        <h1 style="position: relative; left:106px; top: -6px;"> PS5 Games </h1> <hr>
    </div>
    <br><br/>
                ...
                <ItemTemplate>
                    <div class="games-container">
                            <div class="games">
                                ...
                                <p style="color:grey;"><asp:label runat="server" ID="Label1" Text='<%# "Pixel:" + Eval("Price") %>' Visible="true"></asp:label></p>
